...
const AboutSection = () => {
  return (
    <div className="flex">
      ...
      <section
        id="aboutus"
        className="relative mr-6 flex w-max  overflow-hidden rounded-3xl bg-gray-1000 p-4 text-[#F9D8DD] dark:bg-[#e476b2] dark:text-gray-900"
      >
        <div className="mx-auto flex items-center justify-center">
          <div className="relative mx-auto px-4 sm:static sm:px-6 lg:px-8">
            <div className="">
              <h1 className="font-inter my-10 items-center justify-center text-7xl font-black uppercase leading-[0.8] tracking-tight text-[#F9D8DD] dark:text-gray-900">
                Over ons
              </h1>
